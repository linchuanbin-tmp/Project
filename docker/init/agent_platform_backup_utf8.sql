...
-- --- Admin's inbox ---
(1,  2, 1, 'New staff onboarding request for Credit Department',        '@credit_mgr requests adding a new analyst to the Credit Department team.',                                                'CHAT', 1, NULL, NULL, '2026-06-20 09:15:00', '2026-06-20 09:15:00', 0),
(2,  4, 1, 'Compliance quarterly audit report submitted',               '@compliance_mgr has uploaded the Q2 internal audit summary for review.',                                                'CHAT', 3, NULL, 'Reviewed and archived.',                  '2026-06-22 14:30:00', '2026-06-22 15:00:00', 0),
(3,  5, 1, 'Bug Report: RAG citation mismatch in loan agreement query', 'User @compliance_staff reported that a RAG answer cited Section 9 instead of Section 4 for the loan agreement template.', 'BUG_REPORT', 3, '{"citationScore":0.31,"question":"What is the maximum credit line for high-net-worth clients?","output":"...Section 4...50 million...","retrievedChunks":["Section 4: Credit limits...","Section 7: Shell companies..."]}', 'Confirmed -- chunk index was stale. Reindexed document #9.', '2026-06-25 10:00:00', '2026-06-25 11:20:00', 0),

-- --- Credit Manager inbox ---
(4,  3, 2, 'RAG access request: Confidential Credit Risk Evaluation',   '@credit_staff requests temporary clearance for "Confidential Credit Risk Evaluation for Corporate Accounts" (Level 3).', 'RAG_APPLY', 2, '{"documentId":8,"title":"Confidential Credit Risk Evaluation for Corporate Accounts","clearanceLevel":3,"reason":"Need to cross-check Q2 audit notes against credit limits."}', NULL, '2026-07-02 16:10:00', '2026-07-02 16:10:00', 0),
(5,  3, 2, 'Task failed: quarterly report data export',                 'Scheduled task "Export Q1 credit portfolio" failed with error: timeout connecting to data warehouse.',                    'CHAT', 1, '{"taskId":4201,"taskType":"DATA_EXPORT"}', NULL, '2026-07-03 08:45:00', '2026-07-03 08:45:00', 0),
(6,  3, 2, 'SQL Audit Alert: sensitive query detected',                 '@credit_staff submitted a DELETE statement via Code Agent. The SQL sandbox intercepted and requires manager review.',   'SQL_AUDIT', 2, '{"sqlHash":"a3f2b1","sql":"DELETE FROM bank_ledger WHERE customer_id = 992 AND balance < 100.00;","riskScore":98}', NULL, '2026-07-04 11:30:00', '2026-07-04 11:30:00', 0),

-- --- Credit Staff inbox ---
(7,  2, 3, 'Your RAG access request was approved',                       'Manager @credit_mgr approved your temporary access to "Confidential Credit Risk Evaluation". Valid for 24 hours.',       'CHAT', 1, '{"documentId":8,"accessExpiry":"2026-07-03T16:10:00"}', NULL, '2026-07-02 16:25:00', '2026-07-02 16:25:00', 0),
(8,  1, 3, 'Welcome to BankAgent platform',                              'Your account has been set up as Credit Staff (Level 1). You can use Tool Agent, Code Agent, and RAG Agent. Please review the user manual for security clearance rules.', 'CHAT', 1, NULL, NULL, '2026-06-15 09:00:00', '2026-06-15 09:00:00', 0),
(9,  2, 3, 'Team meeting schedule updated',                              'The weekly Credit Department review has been moved to Room 302, Friday 10:00 AM.',                                      'CHAT', 3, '{"roomId":2,"scheduleId":510,"time":"2026-07-07T10:00:00"}', 'Attended.', '2026-07-03 18:00:00', '2026-07-04 09:00:00', 0),

-- --- Compliance Manager inbox ---
(10, 5, 4, 'Request to update AML monitoring thresholds',               '@compliance_staff suggests lowering the suspicious-transaction alert threshold from 500k to 300k.',                      'CHAT', 1, NULL, NULL, '2026-07-01 10:15:00', '2026-07-01 10:15:00', 0),
(11, 5, 4, 'Bug Report: RAG returned wrong security level for doc #12',  'RAG Agent answered a Level-3 question citing a Level-2 source. Audit trace attached.',                                  'BUG_REPORT', 2, '{"citationScore":0.45,"question":"What are the investigation thresholds for shell companies?","output":"Level-1 public...","expectedLevel":3,"actualLevel":1}', NULL, '2026-07-03 14:20:00', '2026-07-03 14:20:00', 0),
(12, 1, 4, 'System maintenance notice',                                  'Scheduled maintenance on 2026-07-10 02:00-04:00 UTC. Milvus vector store will be briefly unavailable.',                'CHAT', 1, NULL, NULL, '2026-07-05 12:00:00', '2026-07-05 12:00:00', 0),

-- --- Compliance Staff inbox ---
(13, 4, 5, 'Your bug report has been reviewed',                          'Manager @compliance_mgr reviewed your report on RAG citation mismatch. The relevant document chunks have been reindexed.', 'BUG_REPORT', 3, '{"resolvedBy":"reindex","documentIds":[9]}', 'Fixed -- thank you for the detailed trace.', '2026-06-25 11:20:00', '2026-06-25 11:20:00', 0),
